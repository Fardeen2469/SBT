...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 04:14 PM
...
(26, 'Covid-19', 'food for poor people', 'admin', 'chars/default.jpg'),
(27, 'ukraine russia war', 'Food', 'admin', 'chars/default.jpg');
...
(42, 'sakshi', 1000, 'trees', '2022-04-14', 'At pune', '7788994455', 'Paid', 'Cash', 'admin');
...
INSERT INTO `raise` (`founder`, `name`, `purpose`, `cover`, `id`) VALUES
('sakshi', 'ukraine russia war', 'food', 'chars/default.jpg', 6);
...
('sakshi', '1234', '7788994455', 'sakshi12@gmail.com', 'pune'),
...
--
ALTER TABLE `doner`
  MODIFY `d_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
